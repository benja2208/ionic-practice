    ...
    angular
        ...
        .factory('GalleryShare', function (AppConfig, gettextCatalog, $ionicActionSheet, Notify, $cordovaSocialSharing) {
            var message = {
                ...
                subject: gettextCatalog.getString("I'm at ") + AppConfig.app.name + '!. ' + gettextCatalog.getString('Install the application and follow me!') + ' ' + AppConfig.app.url,
                ...
                var modal = $ionicActionSheet
                    .show({
                        ...
                        buttonClicked: function (index) {
                            console.log(index);
                            switch (index) {
                                case 0: share('facebook'); break;
                                case 1: share('twitter'); break;
                                case 2: share('whatsapp'); break;
                                case 3: share('email'); break;
                            }
                            modal();
                            //share(index);
                        }
